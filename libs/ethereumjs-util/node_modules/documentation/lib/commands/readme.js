...
module.exports.builder = Object.assign({}, sharedOptions.sharedOutputOptions, sharedOptions.sharedInputOptions, {
  ...
  'diff-only': {
    alias: 'd',
    describe: 'Instead of updating the given README with the generated documentation,' + ' just check if its contents match, exiting nonzero if not.',
    default: false
  },
  quiet: {
    alias: 'q',
...
module.exports.handler = function readme(argv) {
  ...
  documentation.build(argv.input, argv).then(function (comments) {
    return documentation.formats.remark(comments, argv);
  }).then(function (docsAst) {
    return remark().use(plugin, {
