...
function formatType(getHref, node) {
  ...
  switch (node.type) {
    ...
    case Syntax.TypeApplication:
      return formatType(getHref, node.expression).concat(commaList(getHref, node.applications, '<', '>'));
    ...
    case Syntax.OptionalType:
      if (node.default) {
        return decorate(formatType(getHref, node.expression), '?').concat(t('= ' + node.default));
      }
