...
function paramToDoc(param, prefix, i) {
  ...
  switch (param.type) {
    ...
    case 'ObjectProperty':
      {
        return Object.assign(paramToDoc(param.value, prefix + '.' + param.key.name || param.key.value), {
...
function combineTags(inferredTag, explicitTag) {
  ...
  return Object.assign(explicitTag, hasProperties ? {
